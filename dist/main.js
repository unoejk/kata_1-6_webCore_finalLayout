...
var useCollapse = function useCollapse() {
  var mainManifesto = document.querySelector('.mainManifesto');
  var repairBrandBlock = document.querySelector('.repairBrandBlock');
  var repairTechBlock = document.querySelector('.repairTechBlock');
  var openMainManifesto = document.querySelector('.openMainManifesto');
  var openRepairBrandBlock = document.querySelector('.openRepairBrandBlock');
  var openRepairTechBlock = document.querySelector('.openRepairTechBlock');
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   useSidebars: function() { return /* binding */ useSidebars; }
/* harmony export */ });


var useSidebars = function useSidebars() {
  var sidebarBurger = document.querySelector('.sidebarBurger');
  var sidebarCall = document.querySelector('.sidebarCall');
  var sidebarChat = document.querySelector('.sidebarChat');
  var openBurger = document.querySelectorAll('.openBurger');
  var openCall = document.querySelectorAll('.openCall');
  var openChat = document.querySelectorAll('.openChat');
  var closeLeftSidebar = document.querySelectorAll('.closeLeftSidebar');
  var closeRightSidebar = document.querySelectorAll('.closeRightSidebar');
  var overlay = document.querySelector('.overlay');

  //open
  openBurger.forEach(function (el, num) {
    el.addEventListener('click', function () {
      sidebarBurger.classList.add('sidebar--isOpen');
      overlay.classList.add('overlay--isOpen--forLeftSidebar');
    });
  });
  openCall.forEach(function (el, num) {
    el.addEventListener('click', function () {
      sidebarCall.classList.add('sidebar--isOpen');
      overlay.classList.add('overlay--isOpen--forRightSidebar');
    });
  });
  openChat.forEach(function (el, num) {
    el.addEventListener('click', function () {
...
var useSwiper = function useSwiper() {
  var cardsSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".cardsSwiper", {
  ...
  var navSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".navSwiper", {
    spaceBetween: 4,
    slidesPerView: 'auto',
    //сколько слайдов в контейнере
    loop: true,
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _js_sidebars__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./js/sidebars */ "./src/js/sidebars.js");
/* harmony import */ var _js_swiper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./js/swiper */ "./src/js/swiper.js");
/* harmony import */ var _js_collapse__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./js/collapse */ "./src/js/collapse.js");
...
// go-go
(0,_js_sidebars__WEBPACK_IMPORTED_MODULE_0__.useSidebars)();
(0,_js_swiper__WEBPACK_IMPORTED_MODULE_1__.useSwiper)();
(0,_js_collapse__WEBPACK_IMPORTED_MODULE_2__.useCollapse)();
}();
/******/ })()
;
